	...
	<div class="topNav">
		<div class="container">
			<div class="alignR">
				...
				<a href="<?php echo base_url()?>"><span class="icon-edit"></span> Free Register </a> 
				<a href="<?php echo base_url()?>"><span class="icon-envelope"></span> Contact us</a>
		...
		<div class="container">
		  ...
		  <div class="nav-collapse">
			<ul class="nav">
			  ...
			  <li class=""><a href="<?php echo base_url()?>">List View</a></li>
			  <li class=""><a href="<?php echo base_url()?>">Grid View</a></li>
			  <li class=""><a href="<?php echo base_url()?>">Three Column</a></li>
			  <li class=""><a href="<?php echo base_url()?>">Four Column</a></li>
			  <li class=""><a href="<?php echo base_url()?>">General Content</a></li>
			</ul>
