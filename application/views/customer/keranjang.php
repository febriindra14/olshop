                ...
                <tr><td>ESTIMATE YOUR SHIPPING & TAXES</td></tr>
				 ...
				 <td>
					<form class="form-horizontal">
					  ...
					  <div class="control-group">
						<label class="span2 control-label" for="inputPassword">Provinsi :</label>
						<div class="controls">
					  ...
					  <div class="control-group">
						<label class="span2 control-label" for="inputPassword">Kabupaten :</label>
						<div class="controls">
					  ...
					  <div class="control-group">
						<label class="span2 control-label" for="inputPassword">Alamat lengkap :</label>
						<div class="controls">
