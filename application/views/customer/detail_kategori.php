...
<div class="well well-small">
	...
	<form class="form-horizontal qtyFrm" action="<?php echo base_url('customer/tambah_cart')?>" method="post">
...
<div class="span9">
	...
	<form class="form-horizontal qtyFrm" action="<?php echo base_url('customer/tambah_cart_detail')?>" method="post">
	<input type="hidden" name="id_cart">
	...
	<input type="hidden" name="harga" value="<?php echo $detail['harga'] ?>">
				 ...
				 <div class="control-group">
				  ...
				  <div class="control-group">
					...
					<div class="controls">
						 <input type="text" class="span11" value="<?php echo ''.$detail['bahan']; ?>" readonly="readonly">
					</div>
				  </div>
            ...
            <ul id="productDetail" class="nav nav-tabs">
              <li class="active"><a href="<?php echo base_url('customer/detail')?>" data-toggle="tab">Product Details</a></li>
        ...
        <div id="myTabContent" class="tab-content tabWrapper">
           <div class="tab-pane fade active in" id="home">
			  <h4>Product Information</h4>
				...
				<tbody>
				<tr class="techSpecRow"><td class="techSpecTD1">Color:</td><td class="techSpecTD2"><?php echo ''.$detail['warna']; ?></td></tr>
		...
		<div class="tab-pane fade" id="profile">
			<div class="row-fluid">	  
			<div class="span2">
				<img src="assets/fronted/assets/img/d.jpg" alt="">
			</div>
			<div class="span6">
				<h5>Product Name </h5>
				<p>
